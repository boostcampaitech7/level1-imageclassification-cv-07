...
class AlbumentationsTransform: #Albumentations 라이브러리를 사용한 변환 클래스
...
class TorchvisionTransform: #Torchvision 라이브러리를 사용한 변환 클래스
    def __init__(self, is_train: bool = True):
        if is_train:
...
class TransformSelector: #변환 라이브러리 선택 클래스
