...
if __name__ == "__main__":
    # 테스트 코드
    #/data/ephemeral/home/Seungcheol/skf_model/0924_model_ensemble/exp/exp1.json
    path = os.path.normpath(r"/data/ephemeral/home/Seungcheol/skf_model/0924_model_ensemble/result/efficientnet/efficientnet.json")
